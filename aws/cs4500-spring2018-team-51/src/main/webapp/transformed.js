...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_react_stars__ = __webpack_require__(11);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_react_stars___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_react_stars__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__AllRatings__ = __webpack_require__(61);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__UserResults__ = __webpack_require__(15);
...
class MovieListing extends React.Component {
  constructor(props) {
    ...
    var _this = this;
    this.serverRequest = axios.get("http://ec2-18-219-31-161.us-east-2.compute.amazonaws.com:8080/api/findFriends/" + this.props.email + "/").then(function (result) {
      _this.setState({
        friends: result.data
      });
    });
  ...
  checkRating() {
    var _this = this;
    this.serverRequest = axios.get("http://ec2-18-219-31-161.us-east-2.compute.amazonaws.com:8080/api/rate/" + this.props.email + "/" + this.props.movieID).then(function (result) {
      if (result.data) {
        _this.getRating();
      }
    });
  ...
  getRating() {
    var _this = this;
    this.serverRequest = axios.get("http://ec2-18-219-31-161.us-east-2.compute.amazonaws.com:8080/api/getrating/" + this.props.email + "/" + this.props.movieID).then(function (result) {
      _this.setState({
  ...
  rate() {
    ...
    var url = "http://ec2-18-219-31-161.us-east-2.compute.amazonaws.com:8080/api/rate/";
    var rating = {
    ...
    return React.createElement(
          ...
          React.createElement(
            ...
            React.createElement(
              ...
              React.createElement(
                "div",
                { className: "rating" },
                React.createElement(__WEBPACK_IMPORTED_MODULE_0_react_stars___default.a, {
                  count: 10,
        ...
        React.createElement(
          ...
          React.createElement(
            ...
            React.createElement(
              "div",
              { className: "modal-body" },
              React.createElement(__WEBPACK_IMPORTED_MODULE_2__UserResults__["a" /* default */], {
                users: users,
      ...
      React.createElement(
        ...
        React.createElement(
          "div",
          { className: "col-1" },
          React.createElement("img", { className: "img-fluid", src: this.props.posterUrl })
        ),
        React.createElement(
          "div",
          { className: "col-11" },
          ...
          React.createElement(
            "div",
            { className: "collapse multi-collapse", id: expandID },
            React.createElement(__WEBPACK_IMPORTED_MODULE_1__AllRatings__["a" /* default */], {
              ref: instance => {
...
/* harmony default export */ __webpack_exports__["a"] = (MovieListing);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__UserListing__ = __webpack_require__(28);
var React = __webpack_require__(0);
var ReactDOM = __webpack_require__(1);
var axios = __webpack_require__(2);
  ...
  render() {
    ...
    for (var i = 0; i < this.state.numResults; i++) {
      if (this.props.users[i] != undefined) {
        ...
        users.push(React.createElement(__WEBPACK_IMPORTED_MODULE_0__UserListing__["a" /* default */], {
          key: id,
          userid: id,
          name: name,
          username: username,
...
/* harmony default export */ __webpack_exports__["a"] = (UserResults);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__MovieListing__ = __webpack_require__(8);
var React = __webpack_require__(0);
var ReactDOM = __webpack_require__(1);
var axios = __webpack_require__(2);
  ...
  render() {
    ...
    for (var i = 0; i < this.state.numResults; i++) {
      if (this.props.movieList[i] != undefined) {
        ...
        movieListings.push(React.createElement(__WEBPACK_IMPORTED_MODULE_0__MovieListing__["a" /* default */], {
          key: id,
          movieID: id,
          plot: plot,
          title: title,
...
class UserListing extends React.Component {
   ...
   */
  addFriend() {
    var baseURL = "http://ec2-18-219-31-161.us-east-2.compute.amazonaws.com:8080/api/addfriend/";
   ...
   */
  acceptRequest() {
    var baseURL = "http://ec2-18-219-31-161.us-east-2.compute.amazonaws.com:8080/api/confirmfriend/";
    var url = baseURL + this.props.email + "/" + this.props.username + "/";
    var _this = this;
    this.serverRequest = axios.post(url).then(function (response) {
   ...
   */
  checkRecommendation() {
    var baseURL = "http://ec2-18-219-31-161.us-east-2.compute.amazonaws.com:8080/api/movie/findrecommendation/";
    var url = baseURL + this.props.email + "/" + this.props.username + "/" + this.props.movieID + "/";
    var _this = this;
   ...
   */
  recommend() {
    var baseURL = "http://ec2-18-219-31-161.us-east-2.compute.amazonaws.com:8080/api/movie/recommend/";
    var url = baseURL + this.props.email + "/" + this.props.username + "/" + this.props.movieID + "/";
    var _this = this;
    this.serverRequest = axios.post(url).then(function (response) {
    ...
    return React.createElement(
      ...
      React.createElement(
        ...
        React.createElement(
          "div",
          { className: "col-1" },
          !this.props.recommend && React.createElement("img", {
            className: "img-fluid",
            src: "https://www.shareicon.net/download/2015/10/04/111640_personal_512x512.png"
          })
        ),
        React.createElement(
          "div",
          ...
          React.createElement(
            "div",
            { className: "custom-btn-group" },
            this.props.received && !this.props.recommend && !myProfile && React.createElement(
              "button",
              {
                className: "btn btn-secondary",
            ...
            this.props.sent && !this.props.recommend && !myProfile && React.createElement(
              "button",
              { className: "btn btn-secondary", disabled: true },
              "Friend Request Sent"
            ),
            this.props.friends && !this.props.recommend && !myProfile && React.createElement(
              "button",
              { className: "btn btn-secondary", disabled: true },
              "Friends"
            ),
            !this.props.received && !this.props.sent && !this.props.friends && !myProfile && !this.props.recommend && React.createElement(
              "button",
              {
                className: "btn btn-secondary",
            ...
            this.props.recommend && !this.state.recommended && React.createElement(
              "button",
              {
                className: "btn btn-secondary",
            ...
            this.state.recommended && React.createElement(
              "button",
              { className: "btn btn-secondary", disabled: true },
              "Already Recommended"
            )
...
/* harmony default export */ __webpack_exports__["a"] = (UserListing);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__SearchResults_js__ = __webpack_require__(27);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__UserResults_js__ = __webpack_require__(15);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__SearchResultsBox_js__ = __webpack_require__(63);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__MovieListing__ = __webpack_require__(8);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__Navbar__ = __webpack_require__(64);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__LandingPage__ = __webpack_require__(65);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6_react_stars__ = __webpack_require__(11);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6_react_stars___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_6_react_stars__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__AdminPage__ = __webpack_require__(66);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__ProfilePage__ = __webpack_require__(68);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__Home__ = __webpack_require__(69);
var React = __webpack_require__(0);
var ReactDOM = __webpack_require__(1);
var axios = __webpack_require__(2);
...
class Main extends React.Component {
  ...
  updateSearchTerm() {
    if (this.refs.searchBox1) {
      if (this.state.searchTerm.length == 0) {
        ...
        var _this = this;
        this.serverRequest = axios.get("http://ec2-18-219-31-161.us-east-2.compute.amazonaws.com:8080/api/movie/title/" + this.state.searchTerm).then(function (result) {
          _this.setState({
            movies: result.data
          });
        });
    ...
    if (this.refs.searchBox2) {
      if (this.state.searchTerm.length == 0) {
        ...
        this.serverRequest = axios.get("http://ec2-18-219-31-161.us-east-2.compute.amazonaws.com:8080/api/searchUser/" + this.state.searchTerm).then(function (result) {
          _this.setState({
            users: result.data
          });
        });
  ...
  checkAdmin() {
    var _this = this;
    this.serverRequest = axios.get("http://ec2-18-219-31-161.us-east-2.compute.amazonaws.com:8080/api/userauthorized/" + this.state.email + "/").then(function (result) {
      _this.setState({
  ...
  getAllUsers() {
    var _this = this;
    this.serverRequest = axios.get("http://ec2-18-219-31-161.us-east-2.compute.amazonaws.com:8080/api/allusers/" + _this.state.email + "/").then(function (result) {
      _this.setState({
  ...
  getFriends() {
    var _this = this;
    this.serverRequest = axios.get("http://ec2-18-219-31-161.us-east-2.compute.amazonaws.com:8080/api/findFriends/" + this.state.email + "/").then(function (result) {
      _this.setState({
        friends: result.data
      });
    });
  ...
  getReceived() {
    var _this = this;
    this.serverRequest = axios.get("http://ec2-18-219-31-161.us-east-2.compute.amazonaws.com:8080/api/getReceived/" + this.state.email + "/").then(function (result) {
      _this.setState({
  ...
  getSent() {
    var _this = this;
    this.serverRequest = axios.get("http://ec2-18-219-31-161.us-east-2.compute.amazonaws.com:8080/api/getSent/" + this.state.email + "/").then(function (result) {
      _this.setState({
  ...
  getUser() {
    var _this = this;
    this.serverRequest = axios.get("http://ec2-18-219-31-161.us-east-2.compute.amazonaws.com:8080/api/findEmail/" + _this.state.email + "/").then(function (result) {
      _this.setState({
        user: result.data
      });
    });
  ...
  getRecommendation() {
    ...
    var _this = this;
    this.serverRequest = axios.get("http://ec2-18-219-31-161.us-east-2.compute.amazonaws.com:8080/api/movie/recommend/" + this.state.email + "/").then(function (result) {
      _this.setState({
  ...
  getTopMovies() {
    var _this = this;
    this.serverRequest = axios.get("http://ec2-18-219-31-161.us-east-2.compute.amazonaws.com:8080/api/movie/topRated").then(function (result) {
      _this.setState({
  ...
  render() {
    if (this.state.isLoggedIn) {
      return React.createElement(
        "section",
        null,
        React.createElement(__WEBPACK_IMPORTED_MODULE_4__Navbar__["a" /* default */], {
        ...
        this.state.adminTime && React.createElement(__WEBPACK_IMPORTED_MODULE_7__AdminPage__["a" /* default */], {
          email: this.state.email,
          allUsers: this.state.allUsers
        }),
        this.state.userTime && React.createElement(__WEBPACK_IMPORTED_MODULE_8__ProfilePage__["a" /* default */], {
          email: this.state.email,
          user: this.state.user,
          receivedRequests: this.state.receivedRequests,
          onChange: this.handleFriendChange
        }),
        this.state.homeTime && React.createElement(__WEBPACK_IMPORTED_MODULE_9__Home__["a" /* default */], {
          email: this.state.email,
          recommendation: this.state.recommendation,
          topMovies: this.state.topMovies
        }),
        !this.state.adminTime && !this.state.userTime && !this.state.homeTime && React.createElement(
          "section",
          null,
          React.createElement(__WEBPACK_IMPORTED_MODULE_2__SearchResultsBox_js__["a" /* default */], {
            ref: "searchBox1",
            type: "movies",
      ...
      return React.createElement(
        "section",
        null,
        React.createElement(__WEBPACK_IMPORTED_MODULE_5__LandingPage__["a" /* default */], {
...
*/
var aa=__webpack_require__(0),l=__webpack_require__(16),B=__webpack_require__(6),C=__webpack_require__(5),ba=__webpack_require__(17),da=__webpack_require__(18),ea=__webpack_require__(19),fa=__webpack_require__(20),ia=__webpack_require__(21),D=__webpack_require__(9);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_react_stars__ = __webpack_require__(11);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_react_stars___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_react_stars__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__RatingListing__ = __webpack_require__(62);
var React = __webpack_require__(0);
var ReactDOM = __webpack_require__(1);
var axios = __webpack_require__(2);
...
class AllRatings extends React.Component {
  ...
  getReviews() {
    var _this = this;
    this.serverRequest = axios.get("http://ec2-18-219-31-161.us-east-2.compute.amazonaws.com:8080/api/getallratings/" + this.props.movieID).then(function (result) {
      _this.setState({
        reviews: result.data
      });
    });
  ...
  render() {
    ...
    for (var i = 0; i < this.state.reviews.length; i++) {
      ...
      ratings.push(React.createElement(__WEBPACK_IMPORTED_MODULE_1__RatingListing__["a" /* default */], {
        key: i,
        movieID: id,
        user: user,
        rating: rating,
...
/* harmony default export */ __webpack_exports__["a"] = (AllRatings);
...
/* harmony default export */ __webpack_exports__["a"] = (RatingListing);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__MovieListing__ = __webpack_require__(8);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__SearchResults_js__ = __webpack_require__(27);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__UserResults_js__ = __webpack_require__(15);
var React = __webpack_require__(0);
var ReactDOM = __webpack_require__(1);
var axios = __webpack_require__(2);
...
class SearchResultsBox extends React.Component {
  ...
  render() {
    return React.createElement(
      "div",
      { className: "searchContainer col-12" },
      React.createElement(
        "div",
        { className: "col-10" },
        this.props.type == "movies" && this.props.list.length > 0 && React.createElement(
          "div",
          null,
          React.createElement(
            "h3",
          ...
          React.createElement(__WEBPACK_IMPORTED_MODULE_1__SearchResults_js__["a" /* default */], {
            movieList: this.props.list,
            email: this.props.email
          })
        ),
        this.props.type == "users" && this.props.list.length > 0 && React.createElement(
          "div",
          null,
          React.createElement(
            "h3",
          ...
          React.createElement(__WEBPACK_IMPORTED_MODULE_2__UserResults_js__["a" /* default */], {
...
/* harmony default export */ __webpack_exports__["a"] = (SearchResultsBox);
...
class Navbar extends React.Component {
   ...
   */
  logOut() {
    var baseURL = "http://ec2-18-219-31-161.us-east-2.compute.amazonaws.com:8080/api/logout/";
    var url = baseURL + this.props.email + "/";
    var _this = this;
    this.serverRequest = axios.post(url).then(response => {
  ...
  render() {
    ...
    return React.createElement(
      ...
      React.createElement(
        "a",
        { className: "navbar-brand", href: "#", onClick: this.homeTime.bind(this) },
      ...
      React.createElement(
        "div",
        { className: "collapse navbar-collapse", id: "containerNavbar" },
        React.createElement(
          "form",
          { className: "form-inline my-2 my-md-0 mr-auto ml-auto" },
        ...
        React.createElement(
          ...
          React.createElement(
            ...
            React.createElement(
              ...
              this.props.adminStatus && React.createElement(
                "a",
                {
...
class LandingPage extends React.Component {
  ...
  createAccount(e) {
    e.preventDefault();
    var url = "http://ec2-18-219-31-161.us-east-2.compute.amazonaws.com:8080/api/user/insert/";
    var user = {
    ...
    var _this = this;
    this.serverRequest = axios.post(url, user).then(response => {
   ...
   */
  login() {
    var url = "http://ec2-18-219-31-161.us-east-2.compute.amazonaws.com:8080/api/login/";
    var user = {
        ...
        React.createElement(
          ...
          React.createElement(
            ...
            React.createElement(
              "h4",
              null,
              "Bridging the chasm between Netflix and Facebook"
            ),
            React.createElement(
              "p",
              null,
              "Welcome to the social media platform for movie lovers. Spoiled Tomatillos makes it easy to find new movies and share movies you love with friends."
            )
          ),
          React.createElement(
            "div",
            { className: "col-6 registration" },
            React.createElement(
              "div",
              ...
              React.createElement(
                "h4",
                null,
                "Register to join Spoiled Tomatillos"
              ),
              React.createElement(
                "form",
                null,
                ...
                this.state.registrationError != "" && React.createElement(
                  "div",
                  { className: "alert alert-danger" },
            ...
            React.createElement(
              ...
              React.createElement(
                "a",
                { href: "#", "data-toggle": "modal", "data-target": "#signInModal" },
                "Sign in"
              )
            )
          )
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__AdminRow__ = __webpack_require__(67);
var React = __webpack_require__(0);
var ReactDOM = __webpack_require__(1);
var axios = __webpack_require__(2);
...
class AdminPage extends React.Component {
    ...
    render() {
        ...
        for (var i = 0; i < this.props.allUsers.length; i++) {
            ...
            users.push(React.createElement(__WEBPACK_IMPORTED_MODULE_0__AdminRow__["a" /* default */], {
                key: username,
                firstName: firstName,
                lastName: lastName,
                username: username,
        ...
        return React.createElement(
            ...
            React.createElement(
                "p",
                null,
                "Thank you for helping to keep things running smoothly here at Spoiled Tomatillos. Please do not let this administrative power go to your head."
            ),
            React.createElement(
                "h5",
                null,
...
/* harmony default export */ __webpack_exports__["a"] = (AdminPage);
...
class AdminRow extends React.Component {
   ...
   */
  makeAdmin() {
    var baseURL = "http://ec2-18-219-31-161.us-east-2.compute.amazonaws.com:8080/api/makeAdmin/";
    var url = baseURL + this.props.email + "/" + this.props.username + "/";
    var _this = this;
    this.serverRequest = axios.post(url).then(function (response) {});
  }
   ...
   */
  removeUser() {
    var baseURL = "http://ec2-18-219-31-161.us-east-2.compute.amazonaws.com:8080/api/deleteuser/";
    var url = baseURL + this.props.email + "/" + this.props.username + "/";
    var _this = this;
    this.serverRequest = axios.post(url).then(function (response) {});
  }
...
/* harmony default export */ __webpack_exports__["a"] = (AdminRow);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__UserListing__ = __webpack_require__(28);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__MovieListing__ = __webpack_require__(8);
var React = __webpack_require__(0);
var ReactDOM = __webpack_require__(1);
var axios = __webpack_require__(2);
...
class ProfilePage extends React.Component {
  constructor(props) {
    ...
    var _this = this;
    this.serverRequest = axios.get("http://ec2-18-219-31-161.us-east-2.compute.amazonaws.com:8080/api/movie/getAllRecommendations/" + this.props.email + "/").then(function (result) {
      _this.setState({
    ...
    for (var i = 0; i < this.props.receivedRequests.length; i++) {
      ...
      this.serverRequest = axios.get("http://ec2-18-219-31-161.us-east-2.compute.amazonaws.com:8080/api/findEmail/" + pfEmail + "/").then(function (result) {
  ...
  render() {
    ...
    for (var i = 0; i < this.state.users.length; i++) {
      ...
      requests.push(React.createElement(__WEBPACK_IMPORTED_MODULE_0__UserListing__["a" /* default */], {
        key: i,
        userid: id,
        name: name,
        username: username,
    ...
    for (var i = 0; i < this.state.recommendations.length; i++) {
      ...
      var rec = this.state.recommendations[this.state.recommendations.length - i - 1].n.sender;
      var mov = this.state.recommendations[this.state.recommendations.length - i - 1].m;
      var key = this.state.recommendations.length - i - 1;

      recommendations.push(React.createElement(
        "p",
        null,
        rec + " recommended:"
      ));
      recommendations.push(React.createElement(__WEBPACK_IMPORTED_MODULE_1__MovieListing__["a" /* default */], {
        key: key,
        movieID: mov.movieID,
        plot: mov.plot,
        title: mov.title,
    ...
    return React.createElement(
      ...
      React.createElement(
        ...
        noRequests && React.createElement(
          "p",
          null,
          React.createElement(
            "i",
        ...
        noRecommendations && React.createElement(
          "p",
          null,
          React.createElement(
            "i",
...
class Home extends React.Component {
  ...
  render() {
    ...
    return React.createElement(
      ...
      this.props.recommendation == "NONE" && React.createElement(
        "h6",
        null,
        React.createElement(
          "i",
          null,
          "We can't recommend a movie for you until you rate some movies you've already seen!"
        )
      ),
      this.props.recommendation != "NONE" && React.createElement(
        "section",
        ...
        React.createElement(__WEBPACK_IMPORTED_MODULE_0__MovieListing__["a" /* default */], {
      ...
      React.createElement(
        ...
        React.createElement(
          "i",
          null,
          "These are the best movies around, according to our users"
        )
      ),
      movieListings
    );
